...
from evosax.types import Fitness, Metrics, Population, PyTree, Solution, State
...
class BSCPGProblem(Problem):
    ...
    def __init__(
        ...
        print("env_state: ", env_state[0])
        policy_params = self.policy.init(key, env_state[0], key)
        # print("policy_params: ", policy_params.)

        action = self.policy.apply(policy_params, env_state[0], key)
